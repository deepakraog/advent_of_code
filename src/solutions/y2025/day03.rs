...
fn find_max_twelve_digit_number_v2(line: &str) -> u64 {
    ...
    for pos in 0..k {
        ...
        let start_idx = if selected_indices.is_empty() { 0 } else { selected_indices.last().unwrap() + 1 };
...
818181911112111";
    ...
    fn test_find_max_twelve_digit() {
        assert_eq!(find_max_twelve_digit_number_v2("987654321111111"), 987654321111);
        assert_eq!(find_max_twelve_digit_number_v2("811111111111119"), 811111111119);
        assert_eq!(find_max_twelve_digit_number_v2("234234234234278"), 434234234278);
        assert_eq!(find_max_twelve_digit_number_v2("818181911112111"), 888911112111);
    }
